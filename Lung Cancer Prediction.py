# Mount Google Drive removed for local execution
...
img_path = 'dataset/test/squamous.cell.carcinoma_left.hilum_T1_N2_M0_IIIa/000108 (3).png'
...
img_path = 'dataset/test/adenocarcinoma_left.lower.lobe_T2_N0_M0_Ib/000000 (3).png'
img = load_and_preprocess_image(img_path, IMAGE_SIZE)
predictions = model.predict(img)
predicted_class = np.argmax(predictions[0])
predicted_label = class_labels[predicted_class]
...
img_path = 'dataset/test/large.cell.carcinoma_left.hilum_T2_N2_M0_IIIa/000000 (3).png'
img = load_and_preprocess_image(img_path, IMAGE_SIZE)
predictions = model.predict(img)
predicted_class = np.argmax(predictions[0])
predicted_label = class_labels[predicted_class]
...
img_path = 'dataset/test/normal/10.png'
img = load_and_preprocess_image(img_path, IMAGE_SIZE)
predictions = model.predict(img)
predicted_class = np.argmax(predictions[0])
predicted_label = class_labels[predicted_class]
